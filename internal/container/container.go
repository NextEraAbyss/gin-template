...
func (c *Container) InitRepositories() {
	c.Repositories = &Repositories{
		...
		Article: repositories.NewArticleRepository(c.db),
	}
}
...
func (c *Container) InitServices() {
	c.Services = &Services{
		...
		Article: services.NewArticleService(c.Repositories.Article),
	}
}
...
func (c *Container) InitControllers() {
	c.Controllers = &Controllers{
		...
		Article: controllers.NewArticleController(c.Services.Article),
...
// GetArticleController 获取文章控制器
func (c *Container) GetArticleController() *controllers.ArticleController {
	return c.Controllers.Article
}
